...
const Jobs = () => {
    return (
        <GuestLayout>
            <Head title="Jobs Abroad - Horizon Success Bridge" />

            <PageHeader
                title={jobsPageData.header.title}
                description={jobsPageData.header.description}
                breadcrumbs={[{ text: "Jobs", href: null }]}
            />

            {jobsPageData.sections.map((section, index) => (
                <section
                    key={section.id}
                    id={section.id}
                                ...
                                <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl">
                                    <img
                                        src={`https://images.unsplash.com/photo-${
                                            [
                                                "1486406146926-c627a92ad1ab", // UK - London skyline/business
                                                "1454165804606-c3d57bc86b40", // USA - Office/workspace
                                                "1517245386807-bb43f82c33c4", // Canada - Modern city
                                                "1506973035872-a4ec16b8e8d9", // Australia - Harbour
                                                "1518684079-3c830dcef090", // UAE - Dubai skyline
                                                "1449452198679-05c7fd30f416", // Germany - Industry
                                                "1633004281624-4889a9406564", // Ireland - Dublin
                                                "1469854523086-cc02fe5d8800", // New Zealand - Nature
                                            ][index % 8]
                                    ...
                                    <div className="absolute bottom-10 left-10 right-10">
                                        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
                                            <p className="text-white font-bold text-lg">
                                                "Your global career is closer
                                                than you think. Let us help you
                                                get there."
                                            </p>
                                        </div>
                                    </div>
