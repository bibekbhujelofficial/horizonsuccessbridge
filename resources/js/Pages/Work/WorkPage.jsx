...
const WorkPage = () => {
    return (
        <GuestLayout>
            <Head title="Work Abroad - Horizon Success Bridge" />

            <PageHeader
                title={workPageData.header.title}
                description={workPageData.header.description}
                breadcrumbs={[{ text: "Work", href: null }]}
            />

            {workPageData.sections.map((section, index) => (
                <section
                    key={section.id}
                    id={section.id}
                    ...
                    <div className="max-w-[1450px] mx-auto px-6 lg:px-12 relative z-10">
                        ...
                        >
                            ...
                            <div className="lg:w-1/2 text-center lg:text-left">
                                ...
                                <h2 className="text-3xl md:text-5xl font-black text-primary leading-[1.1] mb-8 tracking-tighter mx-auto lg:mx-0 max-w-2xl">
                                    {section.title}
                                </h2>
                                <p className="text-gray-500 text-lg font-medium leading-relaxed mb-10 max-w-xl mx-auto lg:mx-0">
                                    {section.description}
                                </p>
                                ...
                                <Link
                                    href={section.href}
                                    className="inline-flex items-center justify-center lg:justify-start gap-4 text-[11px] font-black uppercase tracking-[0.2em] text-gray-900 hover:text-secondary transition-colors group w-full lg:w-auto"
                                >
